...
#define TR_MIC_RECORDER                "Запис мікрофона"
#define TR_PUSH_TO_RECORD              "Натисніть для запису"
#define TR_RECORD                      "Записати"
#define TR_STOP                        "Зупинити"
#define TR_REC                         "REC"
#define TR_STARTING_IN                 "Початок через"
#define TR_GET_READY                   "Готуйтесь..."
#define TR_SAVED                       "Збережено:"
#define TR_SAVE_AS                     "Зберегти як"
#define TR_OPEN_ERROR                  "Помилка відкриття"
